<div class="w3-container">
    <h1 class="w3-center">W3 NEWS | EDIT</h1>
    <div class="w3-center">
    ...
    <div class="w3-row">
        ...
        <form action="" method="post" style="max-width: 480px; margin: 32px auto;" enctype="multipart/form-data">
            ...
            <input class="w3-input" type="text" name="title" id="title" value="<?php echo $item->title;?>">
            <label>Description <span class="w3-text-red"><?php echo form_error('description'); ?></span></label>
            <textarea class="w3-input" type="text" name="description" id="description"><?php echo $item->description;?></textarea>
            <label>Cover</label>
            <input class="w3-input" type="file" name="cover" id="cover">
            <input type="hidden" name="cover_old" id="cover_old" value="<?php echo $item->cover;?>">
